              ...
              <li><a href="">contact</a></li>
                <li class="widthLi first">  <div class="input-group" id="searchBar">
                  ...
                  <input type="text" class="form-control" placeholder="Search"  name="search_term">
                    <input type="submit" value="search" name="submitSearch" class="btn btn-info" data-dismiss="modal"></form>
                ...
                <div id="userBarHide"><form method="POST">
                    <?php if(isset($_SESSION["userId"])){
							  ...
							  echo '<button type="button"  data-target="#LoginPop" data-toggle="modal"  class="btn btn-success" data-dismiss="modal"><div  >login</div></button>';
