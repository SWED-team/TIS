...
// value="'.(isset($content["title"]))?$content["title"]:"".'"
		...
		return '    
          ...
          <form id="module_embeded_form"  class="form-horizontal" role="form" enctype="multipart/form-data" method="post" 
          action="'.$url.'">
            ...
            <div class="module_embeded_form_result"></div>
            <button type="button" class="module_embeded_form_submit btn btn-success btn-block" data-loading-text=" Saving..." autocomplete=""off><i class="fa fa-check"></i> Save</button>
          ...
          <script>
					$(".module_embeded_form_submit").each(function(){
						$(this).on("click",function(event){
							...
							$.ajax({
							    ...
							    success: function (returndata) {
						      		form.find(".module_embeded_form_result").hide().html(returndata).fadeIn(200);
						      	},
